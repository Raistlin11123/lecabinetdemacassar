...
class Furniture(models.Model):
	...
	caracteristic = models.CharField(max_length=255, verbose_name='caractéristiques : massif plaque boulle siege // marqueterie sculpture boite_et_coffret jeux bijoux') #faire de même un forme déroulant
